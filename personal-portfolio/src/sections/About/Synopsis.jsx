...
function Synopsis() {
    ...
    return(
            ...
            <p className="text-white text-xl w-1/2 break-keep ml-1 text-left">
                ...
                I thrive on collaborating with cross-functional teams to deliver scalable and efficient solutions, 
                and my passion for staying abreast of industry trends drives my commitment to producing high-quality software.
            </p>
            </>
    );
